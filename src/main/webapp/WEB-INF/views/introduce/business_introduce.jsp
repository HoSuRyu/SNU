...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/assets/css/edu.css">
<link
...
<body>
	<div class="main_box">
		...
		<div>
			<img class="back"
				src="${pageContext.request.contextPath}/assets/img/${output[0].img}" />
		</div>
		<div class="snu_main_box">
			<div class="snu_main_header">
				<div class="edu_intro_left">
					<div class="edu_intro_name">${output[0].cname}</div>
					<div class="edu_intro_capt">국장
						${output[0].ccapt}(${output[0].cdept}${output[0].stunum})</div>
					<img
						src="${pageContext.request.contextPath}/assets/img/snu_logo.png" />
				</div>

			</div>
			<div class="edu_intro_pt">${output[0].cintro}</div>
					...
					<div class="edu_intro_detail_1">
						<div style="display: flex; justify-content: space-between;">
							...
							<a
								...
								href="${busin.link}">${busin.linkname}</a>
						</div>
	...
	<div class="snu_mobile_box" style="font-family: 'NanumGothic';">
		...
		<div class="snu_mobile_main_box">
			...
			<div class="snu_main_header">
				<span>${output[0].cname}</span> <span class="sub_title">국장
					${output[0].ccapt}(${output[0].cdept}${output[0].stunum})</span>
			</div>
				...
				<c:forEach var="busin" items="${output}" varStatus="status">
					...
					<div class="edu_intro_detail">
						<div class="edu_intro_detail_1">
							...
							<div style="margin-top: 15px;" class="detail_body">${status.count}.
								${busin.busin}</div>
						</div>
					</div>
				</c:forEach>
